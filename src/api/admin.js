...
export const getUsers = (params) => api.get('/v1/admin/users', { params });
export const blockUser = (id) => api.patch(`/v1/admin/users/${id}/block`);
export const unblockUser = (id) => api.patch(`/v1/admin/users/${id}/unblock`);
export const deleteUser = (id) => api.delete(`/v1/admin/users/${id}`);
export const exportUsersCsv = () => api.get('/v1/admin/users/export/csv', { responseType: 'blob' });
